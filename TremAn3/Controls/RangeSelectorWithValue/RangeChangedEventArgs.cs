...
namespace TremAn3.Controls
{
    ...
    public class RangeChangedEventArgs : EventArgs
    {
        ...
        /// </summary>
        public RangeSelectorWithValueProperty ChangedRangeProperty { get; private set; }
        ...
        public RangeChangedEventArgs(double oldValue, double newValue, RangeSelectorWithValueProperty changedRangeProperty)
        {
            OldValue = oldValue;
            NewValue = newValue;
    ...
    /// RangeSelector
    /// </summary>
    public enum RangeSelectorWithValueProperty
    {
        /// <summary>
