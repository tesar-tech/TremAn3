...
namespace TremAn3.Controls
{
    /// <summary>
    /// RangeSelectorWitValues is extension of RangeSelector from toolkit.
    /// </summary>
    ...
    [TemplateVisualState(Name = "ValuePressed", GroupName = "CommonStates")]
    ...
    [TemplatePart(Name = "ValueThumb", Type = typeof(Thumb))]
    ...
    public partial class RangeSelectorWithValue : Control
    {
        ...
        /// </summary>
        public static readonly DependencyProperty MinimumProperty = DependencyProperty.Register(nameof(Minimum), typeof(double), typeof(RangeSelectorWithValue), new PropertyMetadata(DefaultMinimum, MinimumChangedCallback));

        /// <summary>
        /// Identifies the Maximum dependency property.
        /// </summary>
        public static readonly DependencyProperty MaximumProperty = DependencyProperty.Register(nameof(Maximum), typeof(double), typeof(RangeSelectorWithValue), new PropertyMetadata(DefaultMaximum, MaximumChangedCallback));

        /// <summary>
        /// Identifies the RangeMin dependency property.
        /// </summary>
        public static readonly DependencyProperty RangeMinProperty = DependencyProperty.Register(nameof(RangeMin), typeof(double), typeof(RangeSelectorWithValue), new PropertyMetadata(DefaultMinimum, RangeMinChangedCallback));

        /// <summary>
        /// Identifies the RangeMax dependency property.
        /// </summary>
        public static readonly DependencyProperty RangeMaxProperty = DependencyProperty.Register(nameof(RangeMax), typeof(double), typeof(RangeSelectorWithValue), new PropertyMetadata(DefaultMaximum, RangeMaxChangedCallback));
        public static readonly DependencyProperty ValueProperty = DependencyProperty.Register(nameof(Value), typeof(double), typeof(RangeSelectorWithValue), new PropertyMetadata(DefaultValue, ValueChangedCallback));

        /// <summary>
        /// Identifies the StepFrequency dependency property.
        /// </summary>
        public static readonly DependencyProperty StepFrequencyProperty = DependencyProperty.Register(nameof(StepFrequency), typeof(double), typeof(RangeSelectorWithValue), new PropertyMetadata(DefaultStepFrequency));
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RangeSelectorWithValue"/> class.
        /// Create a default range selector control.
        /// </summary>
        public RangeSelectorWithValue()
        {
            DefaultStyleKey = typeof(RangeSelectorWithValue);
        }
        ...
        protected override void OnApplyTemplate()
        {
            ...
            _valueThumb = GetTemplateChild("ValueThumb") as Thumb;
            ...
            if (_valueThumb != null)
            {
                _valueThumb.DragCompleted += Thumb_DragCompleted;
                _valueThumb.DragDelta += ValueThumb_DragDelta;
                _valueThumb.DragStarted += ValueThumb_DragStarted;
                _valueThumb.KeyDown += ValueThumb_KeyDown;
                _valueThumb.KeyUp += Thumb_KeyUp;
            }
        ...
        private void ValueThumb_KeyDown(object sender, KeyRoutedEventArgs e)
        {
            switch (e.Key)
            {
                case VirtualKey.Left:
        ...
        private void ContainerCanvas_PointerExited(object sender, PointerRoutedEventArgs e)
        {
            ...
            if (_pointerManipulatingMin)
            {
                ...
                ValueChanged?.Invoke(this, new RangeChangedEventArgs(RangeMin, normalizedPosition, RangeSelectorWithValueProperty.MinimumValue));
            }
            else if (_pointerManipulatingMax)
            {
                _pointerManipulatingMax = false;
                _containerCanvas.IsHitTestVisible = true;
                ValueChanged?.Invoke(this, new RangeChangedEventArgs(RangeMax, normalizedPosition, RangeSelectorWithValueProperty.MaximumValue));
            }
        ...
        {
            var rangeSelector = d as RangeSelectorWithValue;
        ...
        private static void ValueChangedCallback(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            var newValue = (double)e.NewValue;
            rangeSelector.ValueToStepFrequency();

            rangeSelector.SyncValueThumb();
        }
        ...
        private void ValueToStepFrequency()
        {
            Value = MoveToStepFrequency(Value);
        }
        ...
        private void SyncValueThumb()
        {
            var relativeVal = ((Value - Minimum) / (Maximum - Minimum)) * DragWidth();
            Canvas.SetLeft(_valueThumb, relativeVal);
        ...
        private void ValueThumb_DragDelta(object sender, DragDeltaEventArgs e)
        {
            ...
            Value = DragThumb(_valueThumb, 0, DragWidth(), _absolutePosition);

            if (_toolTipText != null)
            {
                UpdateToolTipText(this, _toolTipText, Value);
            }
        }
